					...
					<div className="space-y-8">
						...
						<h1 className="text-5xl font-semibold tracking-tight text-gray-800 dark:text-white sm:text-6xl lg:text-7xl">
							...
							<Highlighter action="highlight" color="#4f39f6">
								<span className="text-white font-bold">on your terms.</span>
							</Highlighter>
						</h1>

						{/* Subheadline */}
						<p className="text-lg leading-8 text-gray-600 dark:text-gray-300 sm:text-xl">
							Let investors compete for your startup — you choose the best
							partner. Get transparent terms, better valuations, and accelerated
							growth.
						</p>
						...
						<div className="flex flex-col sm:flex-row items-start gap-4">
							<Button
								asChild
								size="lg"
								className="h-12 px-8 group bg-indigo-600 text-white shadow-lg shadow-purple-500/30 w-full sm:w-auto"
							>
								<Link to="/sign-up" className="font-semibold text-lg">
									Get Started
								</Link>
							</Button>
						</div>
