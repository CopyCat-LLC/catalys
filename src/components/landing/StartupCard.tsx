...
const StartupCard = ({ animate = true }: StartupCardProps) => {
	...
	return (
		<Card className="max-w-md mx-auto backdrop-blur-sm bg-white/95 dark:bg-gray-900/95 border border-indigo-100 dark:border-indigo-900/30 shadow-xl hover:shadow-2xl select-none pointer-events-none transition-all duration-300 gap-0">
			<CardHeader className="pb-4">
				<div className="flex items-start gap-4">
					<Avatar className="h-16 w-16 border-3 border-indigo-200 dark:border-indigo-800 ring-4 ring-indigo-50 dark:ring-indigo-950/50">
						<AvatarFallback className="bg-indigo-600 text-white font-semibold text-2xl">
							T
						</AvatarFallback>
					</Avatar>
			...
			<CardContent className="space-y-5">
				...
				<p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
					AI-powered analytics platform helping businesses make data-driven
					decisions with real-time insights and predictive modeling.
				</p>
