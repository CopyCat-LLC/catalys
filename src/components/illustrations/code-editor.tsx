		...
		<div data-slot="code-editor-illustration" className="h-full w-full">
			<div className="relative h-full w-full">
				<div className="absolute top-0 left-[50%] z-10 w-full -translate-x-[50%] translate-y-0">
					<div className="border-border bg-muted dark:border-border/5 dark:border-t-border/15 dark:bg-accent/30 relative flex min-h-[540px] min-w-[460px] flex-col gap-4 rounded-[12px] border">
						...
						<div className="relative w-full grow overflow-hidden">
							<div className="absolute top-0 left-0 translate-x-0 px-8 transition-all duration-1000 ease-in-out group-hover:translate-x-full group-hover:opacity-0">
							...
							<div className="absolute top-0 left-0 translate-x-full px-8 opacity-0 transition-all duration-1000 ease-in-out group-hover:translate-x-0 group-hover:opacity-100">
								<pre className="text-muted-foreground font-mono text-xs">
									<span className="text-brand">@import</span>
									<span className="text-brand-foreground">
										{" "}
