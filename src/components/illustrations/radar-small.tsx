...
import ShadcnLogo from "@/components/logos/shadcn-ui";
...
function RadarSmallIllustration({
	...
	const createSegments = (index: number = 0): JSX.Element | null => {
		...
		return (
			<>
				<div
					className="bg-brand-foreground/10 absolute top-1/2 left-0 h-px w-full"
					style={{
	...
	return (
		...
		>
			<div className="relative flex aspect-square h-full w-full items-end">
				<div className="relative aspect-square h-full w-full p-6">
					{createSegments()}
