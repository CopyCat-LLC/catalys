...
function RadarIllustration({
	...
	const createSegments = (index: number = 0): JSX.Element | null => {
		...
		return (
			<>
				<div
					className="bg-brand-foreground/20 absolute top-1/2 left-0 h-px w-full"
					style={{
	...
	return (
		...
		>
			<div className="relative h-full w-full overflow-hidden">
				<div className="relative -top-px h-full w-full">
					<div className="relative aspect-square h-[200%] w-full p-12">
						{createSegments()}
						<div className="border-background relative h-full w-full rounded-full border-12">
							{createCircles()}
							<div
